...
namespace ChocolateDelivery.BLL
{
    public class ChefBC
    {
        ...
        public ChefBC(ChocolateDeliveryEntities benayaatEntities)
        {
        ...
        public SM_Chefs CreateChef(SM_Chefs categoryDM)
        {
            try
            {
                var query = (from o in context.sm_chefs
                ...
                {
                    context.sm_chefs.Add(categoryDM);
                }
                context.SaveChanges();
            }
        ...
        public SM_Chefs? GetChef(int chef_id)
        {
            ...
            try
            {
                area = (from o in context.sm_chefs
        ...
        public SM_Chef_Products CreateChefProduct(SM_Chef_Products invoiceDM)
        {
            try
            {
                var query = (from o in context.sm_chef_products
                ...
                {
                    context.sm_chef_products.Add(invoiceDM);
                }
                context.SaveChanges();
            }
        ...
        public List<SM_Chef_Products> GetAllChefProducts(long chef_id)
        {
            ...
            try
            {
                ...
                var query = (from c in context.sm_chef_products
                             from o in context.sm_products                            
        ...
        public bool DeleteChefProduct(long detail_id)
        {
            try
            {
                var detail = (from o in context.sm_chef_products
                              where o.Id == detail_id
                              select o).FirstOrDefault();
                if (detail != null)
                {
                    context.sm_chef_products.Remove(detail);
                    context.SaveChanges();
                }
                else {
                    return false;
