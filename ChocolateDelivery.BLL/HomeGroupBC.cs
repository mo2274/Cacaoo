...
{
    public class HomeGroupBC
    {
        private ChocolateDeliveryEntities context;

        public HomeGroupBC(ChocolateDeliveryEntities chocolateDeliveryEntities)
        {
        ...
        public List<SM_Home_Groups> GetAllGroups()
        {
            ...
            try
            {
                userMenu = (from o in context.sm_home_groups
                            select o).ToList();
        ...
        public SM_Home_Groups CreateGroup(SM_Home_Groups CustomerDM)
        {
            try
            {
                ...
                {
                    var Customer = (from o in context.sm_home_groups
                ...
                {
                    context.sm_home_groups.Add(CustomerDM);
                    context.SaveChanges();
                }
            }
        ...
        public SM_Home_Group_Details CreateGroupDetail(SM_Home_Group_Details CustomerDM)
        {
            try
            {
                ...
                {
                    var Customer = (from o in context.sm_home_group_details
                    ...
                    {
                        context.sm_home_group_details.Add(CustomerDM);
                        context.SaveChanges();
                    }
                }
        ...
        public List<SM_Home_Group_Details> GetAllGroupDetails(long grp_id)
        {
            ...
            try
            {
                var groupDetails = (from o in context.sm_home_group_details
                ...
                foreach (var groupDetail in groupDetails)
                {
                    ...
                    {
                        var subquery = (from o in context.sm_home_group_details
                                        from i in context.sm_categories
                    ...
                    {
                        var subquery = (from o in context.sm_home_group_details
                                        from i in context.sm_sub_categories
                    ...
                    {
                        var subquery = (from o in context.sm_home_group_details
                                        from i in context.sm_restaurants
                    ...
                    {
                        var subquery = (from o in context.sm_home_group_details
                                        from i in context.sm_occasions
        ...
        public List<SM_Home_Group_Details> GetGroupDetails(long grp_id)
        {
            ...
            {
                var groupDetails = (from o in context.sm_home_group_details
                                    from g in context.sm_home_groups
        ...
        public SM_Home_Group_Details? GetGroupDetail(long grp_detail_id)
        {
            ...
            try
            {
                userMenu = (from o in context.sm_home_group_details
        ...
        public bool RemoveGroupdetail(long grp_detail_id)
        {
            ...
            try
            {
                ...
                if (Customer != null)
                {
                    ...
                    context.sm_home_group_details.Remove(Customer);
                    context.SaveChanges();
                }
                else
                {
        ...
        public bool RemoveGroup(long grp_id)
        {
            ...
            try
            {
                ...
                var groupList = (from o in context.sm_home_group_details
                                 where o.Group_Id == grp_id
                                 select o).ToList();

                foreach (var grp in groupList)
                {
                    context.sm_home_group_details.Remove(grp);
                }
                ...
                if (Customer != null)
                {
                    ...
                    context.sm_home_groups.Remove(Customer);
                    context.SaveChanges();
                    isremoved = true;
                }
                else
        ...
        public SM_Home_Groups? UpdateSequence(int grp_id, int sequence)
        {
            ...
            try
            {
                Customer = (from o in context.sm_home_groups
                            where o.Group_Id == grp_id
                            select o).FirstOrDefault();
        ...
        public List<Select2DTO> GetGroupItems(short group_type_id)
        {
            ...
            try
            {
                if (group_type_id == GroupType.CATEGORIES)
                {
                    userMenu = (from o in context.sm_categories
                ...
                {
                    userMenu = (from o in context.sm_sub_categories
                                select new Select2DTO
                                {
                ...
                {
                    userMenu = (from o in context.sm_chefs
                ...
                {
                    userMenu = (from o in context.sm_products                              
                                select new Select2DTO
                                {
                ...
                {
                    userMenu = (from o in context.sm_restaurants
                                select new Select2DTO
                                {
                ...
                {
                    userMenu = (from o in context.sm_occasions
                                select new Select2DTO
                                {
        ...
        public void UpdateGroupDetails(int line_no, long grp_id)
        {
            try
            {
                var query = (from o in context.sm_home_group_details
