...
{
    public class BrandBC
    {
        private ChocolateDeliveryEntities context;

        public BrandBC(ChocolateDeliveryEntities benayaatEntities)
        {
        ...
        public SM_Brands CreateBrand(SM_Brands brandDM)
        {
            try
            {
                var query = (from o in context.sm_brands
        ...
        public List<SM_Restaurants> GetBrands(ProductRequest itemRequest, string lang = "E")
        {
            ...
            try
            {
                ...
                var query = (from o in context.sm_products
                             from b in context.sm_restaurants
        ...
        public List<SM_Sub_Categories> GetBrandCategories(long brand_id)
        {
            ...
            try
            {
                ...
                categoryList = (from o in context.sm_restaurants
        ...
        public List<SM_Products> GetBrandCategoryProducts(long brand_id, long cat_id)
        {
            ...
            try
            {
                ...
                productList = (from o in context.sm_restaurants
                               from p in context.sm_products
                               from s in context.sm_sub_categories
