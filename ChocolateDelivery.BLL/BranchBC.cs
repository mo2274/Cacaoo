...
namespace ChocolateDelivery.BLL
{
    public class BranchBC
    {
        ...
        public BranchBC(ChocolateDeliveryEntities chocolateDeliveryEntities)
        {
        ...
        public SM_Restaurant_Branches CreateBranch(SM_Restaurant_Branches brandDM)
        {
            try
            {
                var query = (from o in context.sm_restaurant_branches
                ...
                {
                    context.sm_restaurant_branches.Add(brandDM);
                }
                context.SaveChanges();
            }
        ...
        public SM_Restaurant_Branches? GetBranch(int brand_id)
        {
            ...
            try
            {
                ...
                area = (from o in context.sm_restaurant_branches
        ...
        public List<SM_Restaurant_Branches> GetRestaurantBranches(long restaurant_id)
        {
            ...
            try
            {
                customer = (from o in context.sm_restaurant_branches
