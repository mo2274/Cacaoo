...
{
    public class OccasionBC
    {
        private ChocolateDeliveryEntities context;

        public OccasionBC(ChocolateDeliveryEntities benayaatEntities)
        {
        ...
        public SM_Occasions CreateOccasion(SM_Occasions categoryDM)
        {
            try
            {
                var query = (from o in context.sm_occasions
                ...
                {
                    context.sm_occasions.Add(categoryDM);
                }
                context.SaveChanges();
            }
        ...
        public SM_Occasions? GetOccasion(int category_id)
        {
            ...
            try
            {
                ...
                area = (from o in context.sm_occasions
        ...
        public List<SM_Occasions> GetOccasions()
        {
            ...
            try
            {
                occasions = (from o in context.sm_occasions
                              where o.Show
                              orderby o.Sequence
                              select o).ToList();
